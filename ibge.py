...
# Nossa missão é conectar 60% da população em 2019, para isso, selecionamos 589 cidades com alto potencial e agora precisamos de vocês...

# Problemas inerentes ao desafio:

# Esperamos soluções / softwares como produtos finais! :)

# As regiões metropolitanas do Brasil são muita diversas, e nem sempre cobrimos 100% da área de uma cidade. 

# Como podemos definir de forma assertiva onde vamos efetivamente fazer entregas? (por exemplo, em São Paulo entregamos em cerca de 70% dos bairros da cidade tanto por causa de pouca densidade como por risco de roubo de carga)
# Dicas: 
# Levar em consideração risco da área de cobertura, impactos em densidade (pacote/km percorrido)  - métrica intimamente relacionada a precificação e chance de criar rotas atraentes para os drivers
# Utilizar população como aproximação para quantidade potencial de pacotes a serem entregues 
